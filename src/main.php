...
case 'perf':
case 'p':
	perf($pf, $args['at'] ?? 'now', $args['columns'] ?? 'default', $args['rows'] ?? 'open');
	break;
...
case '--help':
	...
	fwrite(STDERR, "pfm perf|p [at:<date>] [columns:default|days|weeks|months|years] [rows:all|open|ticker1,ticker2…]\n");
